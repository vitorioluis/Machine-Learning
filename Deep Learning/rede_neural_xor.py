...
if __name__ == "__main__":
    ...
    num_of_iters = 1000  # Número de interações (epocas)
    learning_rate = 0.3  # taxa de aprendizagem


    trained_parameters = model(X, Y, n_x, n_h, n_y, num_of_iters, learning_rate, m)
    ...
    print('Previsão Rede Neural por exemplo ({:d}, {:d}) é {:d}'.format(
