<<<<<<< HEAD:Deep Learning/rn_dsa.py
"""
network1.py
~~~~~~~~~~

Um módulo para implementar uma rede neural com o aprendizado baseado no algoritmo Stochastic Gradient Descent para
uma rede neural feedforward. Os gradientes são calculados usando backpropagation.
...
O objetivo aqui é compreender bem os conceitos fundamentais e alguns conceitos mais avançados serão discutidos nos
...
def sigmoid_prime(z):
    return sigmoid(z) * (1 - sigmoid(z))
>>>>>>> 2184aa0c699a8d7a43b1728bc51e4f700e54d338:Deep Learning/Network1.py
